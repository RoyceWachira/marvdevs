<%@ Page Title="" Language="C#" MasterPageFile="~/Appart.Master" AutoEventWireup="true" CodeBehind="AdminDash.aspx.cs" Inherits="Apartment_Manager.AdminDash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="search-form">
     ...
     <div class="form-group">
                <asp:Button ID="btnTenants" runat="server" Text="View Tenants" class="btn btn-primary btn-block me-3 mr-3 btn1" OnClick="btnTenants_Click" />
                <br />
                <br />
                <br />
            </div>
    <div class="form-group">
                <asp:Button ID="btnViewPayments" runat="server" Text="View Payments" class="btn btn-primary btn-block me-3 mr-3 btn1" OnClick="btnPayments_Click" />
                <br />
            </div>
